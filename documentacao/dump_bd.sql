...
(2, 'Reparo de equipamento', 320.00, 'Receita', 'Conserto do computador', 2),
...
(7, 'Café e lanches', 200.25, 'Receita', 'Copa e cozinha', 7),
(8, 'Despesas de viagem', 450.30, 'Receita', 'Visita ao cliente', 8),
(9, 'Assinatura de serviços', 100.00, 'Despesa', 'Plataforma de gestão', 9),
(10, 'Compra de móveis', 900.00, 'Receita', 'Mesas e cadeiras', 10),
(11, 'Compra de papel', 120.00, 'Despesa', 'Resma de papel A4', 1),
(12, 'Serviço de limpeza', 250.00, 'Despesa', 'Limpeza mensal', 2),
(13, 'Reparo de ar-condicionado', 600.00, 'Receita', 'Troca de filtro', 3),
(14, 'Hospedagem de site', 150.00, 'Despesa', 'Plano anual', 4),
(15, 'Compra de impressora', 850.00, 'Receita', 'Impressora multifuncional', 5),
(16, 'Despesas com transporte', 300.00, 'Receita', 'Reunião externa', 6),
(17, 'Atualização de software', 450.50, 'Despesa', 'Nova versão do ERP', 7),
(18, 'Compra de toner', 180.00, 'Despesa', 'Toner para impressora', 8),
(19, 'Conserto de cadeira', 75.00, 'Receita', 'Troca de rodinhas', 9),
(20, 'Treinamento interno', 600.00, 'Receita', 'Capacitação de líderes', 10),
(21, 'Compra de telefone', 500.00, 'Receita', 'Telefone sem fio', 1),
(22, 'Assinatura de internet', 300.00, 'Despesa', 'Plano mensal', 2),
(23, 'Instalação de câmera', 900.00, 'Receita', 'Câmeras de segurança', 3),
(24, 'Compra de notebook', 2500.00, 'Receita', 'Notebook para o setor', 4),
(25, 'Despesas com correio', 100.00, 'Receita', 'Envio de documentos', 5),
...
(30, 'Compra de monitor', 750.00, 'Receita', 'Monitor de 27\"', 10),
(31, 'Assinatura de software', 200.00, 'Despesa', 'Plataforma de CRM', 1),
(32, 'Manutenção hidráulica', 350.00, 'Receita', 'Reparo de encanamento', 2),
(33, 'Compra de projetor', 1300.00, 'Receita', 'Projetor para reuniões', 3),
(34, 'Despesas com eventos', 500.00, 'Receita', 'Evento de final de ano', 4),
...
(37, 'Compra de extensão elétrica', 150.00, 'Receita', 'Cabos de energia', 7),
(38, 'Compra de HD externo', 400.00, 'Receita', 'HD para backup', 8),
(39, 'Despesas de transporte', 300.00, 'Receita', 'Visita a fornecedores', 9),
(40, 'Troca de fechadura', 250.00, 'Receita', 'Fechadura eletrônica', 10),
(41, 'Compra de mouse', 120.00, 'Receita', 'Mouse ergonômico', 1),
(42, 'Manutenção de servidor', 800.00, 'Receita', 'Troca de hardware', 2),
(43, 'Compra de papel', 150.00, 'Despesa', 'Resma A3', 3),
(44, 'Despesas com alimentação', 450.00, 'Receita', 'Almoço para o evento', 4),
(45, 'Compra de teclado', 300.00, 'Receita', 'Teclado mecânico', 5),
(46, 'Compra de teclado', 300.00, 'Receita', 'Teclado mecânico', 1),
...
(50, 'Compra de cabo HDMI', 80.00, 'Receita', 'Cabo 4K', 8),
(51, 'Manutenção de elevador', 500.00, 'Receita', 'Troca de peças', 9),
...
(55, 'Despesas com alimentação', 450.00, 'Receita', 'Almoço para o evento', 4);
